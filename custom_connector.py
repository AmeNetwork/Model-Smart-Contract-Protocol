...
class CustomConnector(AbstractConnector):
    ...
    def get_functions(self):
        functions = []
        get_eth_price = abi_to_openai_type(self.abi, "getETHPrice", "when user want to get eth price")
        set_eth_price = abi_to_openai_type(self.abi, "setETHPrice", "set eth price")
        functions.append(get_eth_price)
        functions.append(set_eth_price)
        return functions
